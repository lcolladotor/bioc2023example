# Getting help with `bioc2023example`

Thank you for using `bioc2023example`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/bioc2023example`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/bioc2023example),
...
[search issues and pull requests](https://github.com/lcolladotor/bioc2023example/issues)
